...
from Practica.utils.config import LOGGER_DIR # Importa la ruta del directorio de logs desde config.py
from Practica.utils.logger import setup_logger # Importa la función setup_logger desde logger.py
...
class Funciones_Globales:
    """
    Clase que encapsula funciones de Playwright para interacciones globales
    y validaciones comunes en las pruebas de UI.
    """
    ...
    def __init__(self, page: Page):
        ...
        # Atributos para el manejo de diálogos (alertas, prompts, etc.)
        ...
        # Atributos para el manejo de nuevas pestañas (popups)
        self._popup_detectado = False
        self._popup_page = None 
        self._popup_url_capturado = ""
        self._popup_title_capturado = ""  
        
        # Lista para almacenar todas las nuevas páginas abiertas durante una interacción
        self._all_new_pages_opened_by_click: List[Page] = []
        
        # Registra el manejador de eventos para nuevas páginas.
        # Se asocia el evento "page" del contexto del navegador a un método interno.
